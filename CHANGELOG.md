...
- Browser-free `save_html` support for exact CSS attribute selectors such as
...
- `parse_javascript_array` step for safely converting JavaScript array literals into workflow
  data, with optional positional field mapping to objects.

## [0.4.0] - 2026-09-20

### Added

- `filter_json` step for filtering JSON arrays and objects with declarative conditions and
  selecting only the fields needed for output.
...
[0.7.0]: https://github.com/mehmetemineker/crawlerflow/releases/tag/v0.7.0
